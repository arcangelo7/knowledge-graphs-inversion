...
EXPECTATIONS: dict[TestKey, CaseOutcome] = {
    ...
    ("r2rml", "R2RMLTC0002c"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ("r2rml", "R2RMLTC0002d"): CaseOutcome(InversionOutcome.NOT_SUPPORTED),
    ("r2rml", "R2RMLTC0002e"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ("r2rml", "R2RMLTC0002f"): CaseOutcome(InversionOutcome.FULLY_INVERTED),
    ("r2rml", "R2RMLTC0002g"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ("r2rml", "R2RMLTC0002h"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ...
    ("r2rml", "R2RMLTC0004b"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ...
    ("r2rml", "R2RMLTC0007h"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ...
    ("r2rml", "R2RMLTC0012a"): CaseOutcome(
        ...
        frozenset(
            {
                PartialLoss.COLUMNS_LOST,
                PartialLoss.MULTIPLICITY_LOST,
                PartialLoss.TABLES_LOST,
            }
        ),
    ),
    ...
    ("r2rml", "R2RMLTC0012c"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ("r2rml", "R2RMLTC0012d"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ...
    ("r2rml", "R2RMLTC0015b"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ...
    ("r2rml", "R2RMLTC0019b"): CaseOutcome(
        InversionOutcome.PARTIALLY_INVERTED,
        frozenset({PartialLoss.COLUMNS_LOST}),
    ),
    ("r2rml", "R2RMLTC0020a"): CaseOutcome(InversionOutcome.NON_INVERTIBLE),
    ("r2rml", "R2RMLTC0020b"): CaseOutcome(InversionOutcome.NON_INVERTIBLE),
    ...
    ("rml", "RMLTC0002c-RDB"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ("rml", "RMLTC0002d-RDB"): CaseOutcome(InversionOutcome.NOT_SUPPORTED),
    ("rml", "RMLTC0002e-RDB"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ("rml", "RMLTC0002f-RDB"): CaseOutcome(InversionOutcome.FULLY_INVERTED),
    ("rml", "RMLTC0002g-RDB"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ("rml", "RMLTC0002h-RDB"): CaseOutcome(InversionOutcome.NOT_SUPPORTED),
    ...
    ("rml", "RMLTC0003a-RDB"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ...
    ("rml", "RMLTC0004b-RDB"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ...
    ("rml", "RMLTC0007h-RDB"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ...
    ("rml", "RMLTC0012c-RDB"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ("rml", "RMLTC0012d-RDB"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ...
    ("rml", "RMLTC0015b-RDB"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
    ...
    ("rml", "RMLTC0019b-RDB"): CaseOutcome(InversionOutcome.FORWARD_MAPPING_FAILED),
...
def expected_outcome(suite_id: str, test_id: str) -> CaseOutcome | None:
